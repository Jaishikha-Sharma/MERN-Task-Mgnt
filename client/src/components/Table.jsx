...
const ICONS = {
  high: <MdKeyboardDoubleArrowRight />,
...
setOpenDialog(true);
  ...
  const TableHeader = () => (
    <thead className="w-full border-b border-gray-300">
      <tr className="text-black text-left w-full">
        <th className="py-3 px-4 border-b">Task Title</th>
        <th className="py-3 px-4 border-b">Priority</th>
        <th className="py-3 px-4 border-b">Assests</th>
  ...
  const TableRow = ({ task }) => (
    <tr className="border-b border-gray-200 text-gray-600 hover:bg-gray-300/10">
      ...
      <td>
        <div className="flex tasks-center gap-3">
